import {MdDashboard,MdFitnessCenter,MdEventNote,MdPerson,MdLogout} from "react-icons/md";
		...
		<div className="flex flex-col w-1/6 bg-[#14181f] h-screen border-r border-r-gray-700 ">
			<div className="flex justify-start items-center w-full h-28 pl-5 bg-[#14181f] border-b border-b-gray-700 ">
				...
				<div className="flex flex-col ml-3">
					...
					<p className="text-gray-300 text-xs">Minha Área</p>
				</div>
			</div>
			<div className="m-6">
				<Button icon={<MdEventNote />} texto="Frequência" to="/dashboard" />
				<Button icon={<MdFitnessCenter />} texto="Treinos" to="/treinos" />
